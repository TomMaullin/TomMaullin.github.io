...
\begin{itemize}
    ...
    \item Maullin-Sapey, T. (2025). Thomas Maullin-Sapey’s contribution to the Discussion of ‘Statistical exploration of the Manifold Hypothesis’ by Whiteley et al. JRSSB Discussion Contribution, \url{https://doi.org/10.1093/jrsssb/qkag035}

    \item Radosavljevi\'c, L., Maullin-Sapey, T., Alfaro-Almagro, F., McCarthy, P., Nichols, T.E. \& Smith, S.M. (2025). An Improved Pipeline for Constructing UK Biobank Brain Imaging Confounds. MedRxiv Preprint, \url{https://doi.org/10.1101/2025.11.21.25340740}
    
    \item Maullin-Sapey, T., \& Telschow, F.J.E. (2025). Spatial Confidence Regions for Piecewise Continuous Processes. ArXiv Preprint, \url{https://doi.org/10.48550/arXiv.2511.08216}
    
    \item Maullin-Sapey, T., \& Davenport, S. (2025). Regularity Conditions for Critical Point Convergence. ArXiv Preprint, \url{https://doi.org/10.48550/arXiv.2507.01854}

    \item Ryu, H., Maullin-Sapey, T., Schwartzman, A., \& Davenport, S. (2025). Spatial Confidence Regions for Excursion Sets with False Discovery Rate Control. ArXiv Preprint, \url{https://doi.org/10.48550/arXiv.2504.13124}

    \item Hawes, S. et al. (2025). Longitudinal analysis of the ABCD® study. Developmental Cognitive Neuroscience, 72(1). \url{https://doi.org/10.1016/j.dcn.2025.101518}
